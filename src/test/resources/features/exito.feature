Feature: Purchasing in Exito´s web page
  ...
  Scenario: Purchase a single product by category
    ...
    When goes to finalize the purchase with email "correopruebas@gmail.com" name "Eric" last name "Cartman" id "Cédula ciudadanía" number "1152215765" cell phone "3110987654"
